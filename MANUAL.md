# Manual Setup Steps for Minions Oss-features
...
Go to **GitHub → mxn2020/minions-oss-features → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-features` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-features-web`
- **GitHub repo**: `mxn2020/minions-oss-features`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-features.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-features-docs`
- **GitHub repo**: `mxn2020/minions-oss-features`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-features.minions.help`

### Blog
- **Netlify site name**: `minions-oss-features-blog`
- **GitHub repo**: `mxn2020/minions-oss-features`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-features.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-features.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-features.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-features.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-features/sdk`](https://www.npmjs.com/package/@minions-oss-features/sdk)
- CLI: [`@minions-oss-features/cli`](https://www.npmjs.com/package/@minions-oss-features/cli)
...
Your package: [`minions-oss-features`](https://pypi.org/project/minions-oss-features/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-features` |
| SDK (npm) | `@minions-oss-features/sdk` |
| CLI (npm) | `@minions-oss-features/cli` |
| Python (PyPI) | `minions-oss-features` |
| GitHub | `github.com/mxn2020/minions-oss-features` |
| Docs domain | `oss-features.minions.help` |
| Blog domain | `oss-features.minions.blog` |
| App domain | `oss-features.minions.wtf` |
