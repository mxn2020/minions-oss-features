...
/**
 * @minions-oss-features/cli — CLI for Minions Oss-features
 *
...
import { customTypes } from '@minions-oss-features/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-features'));
        console.log(chalk.dim('Feature backlog, daily picks, implementation plans, and acceptance criteria'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-features/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-features/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-features')}`);
